...
import com.um.canario.models.CityDataOnDemand;
import com.um.canario.models.Country;
import com.um.canario.models.CountryDataOnDemand;
...
privileged aspect CityDataOnDemand_Roo_DataOnDemand {
    ...
    public void CityDataOnDemand.setCountry(City obj, int index) {
